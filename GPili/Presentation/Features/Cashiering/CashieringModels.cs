...
namespace GPili.Presentation.Features.Cashiering
{
    ...
    public partial class ItemTotals : ObservableObject
    {
        ...
        partial void OnOtherPaymentsChanged(ObservableCollection<AlternativePayment> oldValue, ObservableCollection<AlternativePayment> newValue) => NotifyAllTotalsChanged();
