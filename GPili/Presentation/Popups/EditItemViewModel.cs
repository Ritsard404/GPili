...
namespace GPili.Presentation.Popups
{
        ...
        IOrder _order) :  ObservableValidator
    {
        ...
        partial void OnQtyChanged(decimal value) => ValidateProperty(value, nameof(Qty));
        ...
        private async Task SaveItem()
        {
            ...
            if (HasErrors)
            {
                await Toast.Make("Please correct the errors.").Show();
                return;
            }
            ...
            {
                await Toast.Make(message ?? "Please correct the errors.").Show();
                return;
            }
        }
