...
namespace ServiceLibrary.Services.Interfaces
{
    ...
    {
        Task<(bool isSuccess, string Role, string email, string name, string message)> LogIn(string managerEmail, string cashierEmail, string? cardId = null);
        ...
        Task<(bool isSuccess, User? manager)> IsManagerValid(string managerEmail, string? cardId = null);
